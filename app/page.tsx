// 🔮 HOLOGRAM MODE ENABLED FOR TEARDROP LANDING PAGE
...
const GlassButton = ({ href, children }: { href: string; children: React.ReactNode }) => (
  <motion.a
    ...
    whileTap={{ scale: 0.98 }}
    className="group relative inline-flex items-center gap-3 text-white text-base md:text-lg font-light border border-white/30 rounded-full px-6 py-3 md:px-8 md:py-4 backdrop-blur-xl bg-white/10 hover:bg-white/20 transition-all duration-500 overflow-hidden shadow-[0_0_40px_rgba(255,255,255,0.08)]"
  >
    ...
    <span className="relative z-10 whitespace-nowrap tracking-wide">{children}</span>
    <motion.div
      animate={{ x: [0, 6, 0] }}
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="fixed inset-0 bg-gradient-to-b from-white/5 via-black/40 to-black/80 z-0 backdrop-blur-sm"
      />
      ...
      <section className="min-h-screen flex items-center justify-center relative z-10">
        <motion.div style={{ y, opacity: heroOpacity }} className="text-center px-6 max-w-4xl mx-auto">
          <motion.div
            ...
            className="mb-16"
          >
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-serif text-white font-light tracking-wider drop-shadow-[0_0_20px_rgba(255,255,255,0.3)]">
              Teardrop
            </h1>
          </motion.div>
          ...
          >
            Why GPT?
            <br />
            <span className="italic font-medium">Because the <strong>Word</strong> is enough.</span>
          </motion.h2>
